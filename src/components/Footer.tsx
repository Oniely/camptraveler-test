  ...
  return (
    <footer className="flexCenter mb-24">
      <div className="padding-container max-container flex w-full flex-col gap-14">
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map(link => (
                  <Link href={'/'} key={link.label} className="flex gap-4 md:flex-col lg: flex-row">
                    ...
                    <p className="medium-14 whitespace-nowrap text-blue-900">{link.value}</p>
                  </Link>
                ))}
              </FooterColumn>
            </div>
        ...
        <p className="regular-14 w-full text-center text-gray-500">&copy; 2023 Hilink | All rights reserved</p>
