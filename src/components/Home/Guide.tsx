  ...
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24">
        ...
        <p className="uppercase regular-18 text-green-600 -mt-1 mb-3">
          We are here for you
        </p>
      ...
      <div className="flexCenter max-container relative w-full">
        <Image
          ...
          width={1440}
          height={580}
          className="w-full object-cover object-center 2xl:rounded-[3rem]"
        />
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-[2rem] border shadow-md md:left-[5%] lg:top-20">
          <Image
            src={"/meter.svg"}
            alt="meter"
            width={16}
          ...
          <div className="flexBetween flex-col">
            ...
            <div className="flex flex-col w-full">
              <p className="regular-16 textgray-300">
                Start Track
              </p>
